    ...
    <>
      ...
      >
        <div className="space-y-6">
          <div className="">
            <h2 className="text-lg/7 font-bold tracking-tight text-gray-950 mb-2">
              Delete Category
            </h2>
            <p className="text-md/6 text-gray-600">
              Are you sure you want to delete the category <span className="text-brand-700 font-semibold italic">{deletingCategory}</span>?
